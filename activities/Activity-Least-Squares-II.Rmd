...
a\. Use the classical Gram-Schmidt orthogonalization algorithm to find the reduced $\mat{QR}$ factorization and full $\mat{QR}$ factorization of the matrix 
