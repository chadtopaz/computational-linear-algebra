...
$$1/3 = 1/4 + 1/16 + 1/64 + \ldots$$
which in binary is $0.0101010101\dots$.
...
The sign is $s=0$, the exponent is $1021 - 1023 = -2$ and the mantissa is $1.0101010101$ where the $01$ pattern after the decimal point is repeated 26 times. This mantissa is

$$1 + 1/4 + (1/4)^2 + \ldots + (1/4)^26 = \frac{6004799503160661}{4503599627370496}$$
So, our final machine number is this numnber times $1/4$, which is

$$fl(1/3) = \frac{6004799503160661}{18014398509481984}$$

The relative error is

$$\frac{1/3 -fl(1/3)}{1/3}= \frac{1}{54043195528445952} \approx 1.85\times10^{-17}$$
...
sqrt(a^2+b^2)-a
```
The problem is due to the subtraction of nearly equal numbers. To avoid this, we can rationalize the expression,
$$\left(\sqrt{a^2+b^2}-a\right) \times \frac{\sqrt{a^2+b^2}+a}{\sqrt{a^2+b^2}+a}$$
which simplifies to
