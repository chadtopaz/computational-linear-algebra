...
-   Learning R
    ...
    -   [DataCamp](https://www.datacamp.com/) \[See [Getting
        Started](#getting-started) below for a discussion of DataCamp’s
...
-   Reading
    ...
    -   [Course Book: R
        Bootcamp](https://htmlpreview.github.io/?https://github.com/chadtopaz/computational-linear-algebra/blob/main/coursebook/coursebook.html?raw=true)
...
-   Reading
    ...
    -   [Course Book: How Computers Store
        Numbers](https://htmlpreview.github.io/?https://github.com/chadtopaz/computational-linear-algebra/blob/main/coursebook/coursebook.html?raw=true)
...
-   Reading
    ...
    -   [Course Book:
        Interpolation](https://htmlpreview.github.io/?https://github.com/chadtopaz/computational-linear-algebra/blob/main/coursebook/coursebook.html?raw=true)
...
-   Reading
    ...
    -   [Course Book: Least Squares
        II](https://htmlpreview.github.io/?https://github.com/chadtopaz/computational-linear-algebra/blob/main/coursebook/coursebook.html?raw=true)
...
-   Videos
    ...
    -   [What Eigenvalues and Eigenvectors Mean Geometrically
        (9:08)](https://youtu.be/4wTHFmZPhT0)

    -   [Using Determinants to Compute Eigenvalues and Eigenvectors
        (4:35)](https://youtu.be/LsZ-nNy0ZRs)

    -   [Example: Computing Eigenvalues and Eigenvectors
        (7:32)](https://youtu.be/4u55V_Yp-QI)

    -   [Diagonal Matrices are Freaking Awesome
        (6:27)](https://youtu.be/q48o3PXlg4Q)

    -   [How the Diagonalization Process Works
        (7:29)](https://youtu.be/nNwZA1X-C3c)

    -   [Compute Large Powers of a Matrix via Diagonalization
        (3:00)](https://youtu.be/Z8KBxf4C8kk)

    -   [Full Example: Diagonalizing a Matrix
        (10:07)](https://youtu.be/ieWyx2mlZyk)

    -   [Power Method for Eigenvalues
        (8:19)](https://youtu.be/TS32rBteHh4)
...
-   Pset - Eigenvalues II \[[.md for
    viewing](https://github.com/chadtopaz/computational-linear-algebra/blob/main/psets/Pset-Eigenvalues-II.md)\]
    \[[.Rmd for
    editing](https://github.com/chadtopaz/computational-linear-algebra/blob/main/psets/Pset-Eigenvalues-II.Rmd)\]
