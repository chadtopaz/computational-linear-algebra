...
a\. The solution to the approximate steady-state heat flow problem for this plate can be written as a system of linear equations $\mat{A} \vec{x}=\vec{b}$, where $x=(x_1, x_2, \ldots, x_8)^T$ is the vector of temperatures at nodes 1 through 8. Find the $8 \times 8$ matrix $A$ and the vector $b$.
