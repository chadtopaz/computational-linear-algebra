...
Step 2.  Think of $\mathbf{v}_2$ as made up of stuff in the subspace spanned by $\mathbf{q}_1$ and stuff orthogonal to it. Through away stuff in the span of $\mathbf{q}_1$ since we have it covered already. Take what's left of $\mathbf{v}_2$ and turn it unto a unit vector.
