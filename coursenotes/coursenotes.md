...
`{= latex} \renewcommand{\vec}[1]{\bm{#1}} \renewcommand{\mat}[1]{\bm{#1}} \newcommand{\exp}[1]{\mathrm{e}^{#1}} \DeclareMathOperator*{\argmin}{arg\,min} \DeclareMathOperator*{\float}{fl}`
...
![\vec{x}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D "\vec{x}")
and
![\vec{y}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7By%7D "\vec{y}"):
...
2.  Dot product, also known as the inner product. To compute, calculate
    ![\vec{x} \cdot \vec{y} \equiv \vec{x}^T \vec{y}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%5Ccdot%20%5Cvec%7By%7D%20%5Cequiv%20%5Cvec%7Bx%7D%5ET%20%5Cvec%7By%7D "\vec{x} \cdot \vec{y} \equiv \vec{x}^T \vec{y}")
    where the superscript
    ![T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;T "T")
    indicates transpose. Dot product is related to the angle
    ![\theta](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Ctheta "\theta")
    between the two vectors as
    ![\vec{x} \cdot \vec{y} = \|\vec{x}\|\|\vec{y}\| \cos \theta](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%5Ccdot%20%5Cvec%7By%7D%20%3D%20%7C%5Cvec%7Bx%7D%7C%7C%5Cvec%7By%7D%7C%20%5Ccos%20%5Ctheta "\vec{x} \cdot \vec{y} = |\vec{x}||\vec{y}| \cos \theta").
    Rearranging this as
    ![\vec{x} \cdot \vec{y}/\|\vec{y}\| = \|\vec{x}\| \cos \theta](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%5Ccdot%20%5Cvec%7By%7D%2F%7C%5Cvec%7By%7D%7C%20%3D%20%7C%5Cvec%7Bx%7D%7C%20%5Ccos%20%5Ctheta "\vec{x} \cdot \vec{y}/|\vec{y}| = |\vec{x}| \cos \theta")
...
3.  Outer product. To compute, calculate
    ![\vec{x} \otimes \vec{y} \equiv \vec{x}\vec{y}^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%5Cotimes%20%5Cvec%7By%7D%20%5Cequiv%20%5Cvec%7Bx%7D%5Cvec%7By%7D%5ET "\vec{x} \otimes \vec{y} \equiv \vec{x}\vec{y}^T").
    Note that
    ![\vec{x}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D "\vec{x}")
    and
    ![\vec{y}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7By%7D "\vec{y}")
    ...
    then
    ![\vec{x} \otimes \vec{y}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%5Cotimes%20%5Cvec%7By%7D "\vec{x} \otimes \vec{y}")
    is
...
![x](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x "x")
as
![\float(x)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfloat%28x%29 "\float(x)"),
and to reiterate the point above, it is not necessarily true that
![\float(x)=x](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfloat%28x%29%3Dx "\float(x)=x").
...
![\float(x+y) = \float(\float(x)+\float(y)).](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfloat%28x%2By%29%20%3D%20%5Cfloat%28%5Cfloat%28x%29%2B%5Cfloat%28y%29%29. "\float(x+y) = \float(\float(x)+\float(y)).")
...
Well,
![\float(1)=1](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfloat%281%29%3D1 "\float(1)=1")
and
![\float(2^{-53})=2^{-53}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfloat%282%5E%7B-53%7D%29%3D2%5E%7B-53%7D "\float(2^{-53})=2^{-53}").
The (exact) sum is
...
![\float(1+2^{-53})=1](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfloat%281%2B2%5E%7B-53%7D%29%3D1 "\float(1+2^{-53})=1").
...
![\mat{A}\vec{x}=\vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cvec%7Bx%7D%3D%5Cvec%7Bb%7D "\mat{A}\vec{x}=\vec{b}").
...
matrix
![\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D "\mat{A}").

1.  **Invertible** means that the inverse
    ![\mat{A}^{-1}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5E%7B-1%7D "\mat{A}^{-1}")
    exists. This matrix satisfies
    ![\mat{A}\mat{A}^{-1} = \mat{I}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cmat%7BA%7D%5E%7B-1%7D%20%3D%20%5Cmat%7BI%7D "\mat{A}\mat{A}^{-1} = \mat{I}"),
    where
    ![\mat{I}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BI%7D "\mat{I}")
    is the
    ![n \times n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n%20%5Ctimes%20n "n \times n")
    identity matrix.
...
2.  The notation
    ...
    (![\|\det \mat{A}\| \< 1](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%5Cdet%20%5Cmat%7BA%7D%7C%20%3C%201 "|\det \mat{A}| < 1"))
    or expand
    (![\|\det \mat{A}\| \> 1](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%5Cdet%20%5Cmat%7BA%7D%7C%20%3E%201 "|\det \mat{A}| > 1"))
    and/or reflect
    (![\det \mat{A} \< 0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cdet%20%5Cmat%7BA%7D%20%3C%200 "\det \mat{A} < 0")).
    As an example, let

![\mat{A}=\begin{pmatrix}a & b\\\c & d\end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%3D%5Cbegin%7Bpmatrix%7Da%20%26%20b%5C%5Cc%20%26%20d%5Cend%7Bpmatrix%7D. "\mat{A}=\begin{pmatrix}a & b\\c & d\end{pmatrix}.")

For this example,

![\mat{A}^{-1} = \frac{1}{ad-bc}\begin{pmatrix}d & -b\\\\-c & a\end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5E%7B-1%7D%20%3D%20%5Cfrac%7B1%7D%7Bad-bc%7D%5Cbegin%7Bpmatrix%7Dd%20%26%20-b%5C%5C-c%20%26%20a%5Cend%7Bpmatrix%7D. "\mat{A}^{-1} = \frac{1}{ad-bc}\begin{pmatrix}d & -b\\-c & a\end{pmatrix}.")

So
![\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D "\mat{A}")
invertible
![\iff \det \mat{A} \neq 0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Ciff%20%5Cdet%20%5Cmat%7BA%7D%20%5Cneq%200 "\iff \det \mat{A} \neq 0").
...
![\mat{A}\mathbf{v_i}=\lambda_i \mathbf{v_i},](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cmathbf%7Bv_i%7D%3D%5Clambda_i%20%5Cmathbf%7Bv_i%7D%2C "\mat{A}\mathbf{v_i}=\lambda_i \mathbf{v_i},")
...
![\prod_i \lambda_i = \det \mat{A},](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cprod_i%20%5Clambda_i%20%3D%20%5Cdet%20%5Cmat%7BA%7D%2C "\prod_i \lambda_i = \det \mat{A},")

so no
![\lambda_i = 0 \iff \det \mat{A} \neq 0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Clambda_i%20%3D%200%20%5Ciff%20%5Cdet%20%5Cmat%7BA%7D%20%5Cneq%200 "\lambda_i = 0 \iff \det \mat{A} \neq 0").

4.  ![\mat{A} \mathbf{z} \neq 0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Cmathbf%7Bz%7D%20%5Cneq%200 "\mat{A} \mathbf{z} \neq 0")
    for all
    ...
    ![\mathbf{z}=0 \iff \mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7Bz%7D%3D0%20%5Ciff%20%5Cmat%7BA%7D "\mathbf{z}=0 \iff \mat{A}")
    is invertible. Why? If
    ![\mat{A} \mathbf{z} = 0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Cmathbf%7Bz%7D%20%3D%200 "\mat{A} \mathbf{z} = 0")
    for
    ![\mathbf{z} \neq 0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7Bz%7D%20%5Cneq%200 "\mathbf{z} \neq 0"),
    then
    ![\mat{A} \mathbf{z} = 0 \mathbf{z}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Cmathbf%7Bz%7D%20%3D%200%20%5Cmathbf%7Bz%7D "\mat{A} \mathbf{z} = 0 \mathbf{z}"),
...
5.  **Nullspace** just means the parts of
    ...
    for which
    ![\mat{A} \mathbf{v}=0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Cmathbf%7Bv%7D%3D0 "\mat{A} \mathbf{v}=0").
...
9.  ![\mat{A}\vec{x}=\vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cvec%7Bx%7D%3D%5Cvec%7Bb%7D "\mat{A}\vec{x}=\vec{b}")
    has a unique solution for all
    ![\vec{b} \iff](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bb%7D%20%5Ciff "\vec{b} \iff")
    ![\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D "\mat{A}")
...
\vec{b} = \begin{pmatrix}
9 \\\\ 1 \\\\ 35
\end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%0A%5Cbegin%7Bpmatrix%7D%0A1%20%26%203%20%26%201%5C%5C%0A1%20%26%201%20%26%20-1%20%5C%5C%0A3%20%26%2011%20%26%205%0A%5Cend%7Bpmatrix%7D%2C%20%5Cquad%0A%5Cvec%7Bb%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%0A9%20%5C%5C%201%20%5C%5C%2035%0A%5Cend%7Bpmatrix%7D. "\mat{A} = 
\begin{pmatrix}
1 & 3 & 1\\
1 & 1 & -1 \\
3 & 11 & 5
...
![\vec{x} = \begin{pmatrix}  -3 + 2x_3 \\\\ 4 - x_3 \\\\ x_3 \end{pmatrix} = \begin{pmatrix}  -3 \\\\ 4\\\\ 0 \end{pmatrix} + x_3 \begin{pmatrix}  2 \\\\ -1 \\\\ 1 \end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%20%20-3%20%2B%202x_3%20%5C%5C%204%20-%20x_3%20%5C%5C%20x_3%20%5Cend%7Bpmatrix%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%20%20-3%20%5C%5C%204%5C%5C%200%20%5Cend%7Bpmatrix%7D%20%2B%20x_3%20%5Cbegin%7Bpmatrix%7D%20%202%20%5C%5C%20-1%20%5C%5C%201%20%5Cend%7Bpmatrix%7D. "\vec{x} = \begin{pmatrix}  -3 + 2x_3 \\ 4 - x_3 \\ x_3 \end{pmatrix} = \begin{pmatrix}  -3 \\ 4\\ 0 \end{pmatrix} + x_3 \begin{pmatrix}  2 \\ -1 \\ 1 \end{pmatrix}.")
...
![\vec{x}\_a](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D_a "\vec{x}_a").
The forward error is the distance between the two solutions, that is,
![\|\|\vec{x}-\mathbf{x_a}\|\|](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%5Cvec%7Bx%7D-%5Cmathbf%7Bx_a%7D%7C%7C "||\vec{x}-\mathbf{x_a}||").
The backward error is the distance between what the matrix outputs when
applied to those solutions, that is,
![\|\|\mat{A}\vec{x}-\mat{A}\vec{x}\_a\|\|=\|\|\vec{b}-\mat{A}\vec{x}\_a\|\|](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D-%5Cmat%7BA%7D%5Cvec%7Bx%7D_a%7C%7C%3D%7C%7C%5Cvec%7Bb%7D-%5Cmat%7BA%7D%5Cvec%7Bx%7D_a%7C%7C "||\mat{A}\vec{x}-\mat{A}\vec{x}_a||=||\vec{b}-\mat{A}\vec{x}_a||").
...
![\|\| \vec{x} \|\|\_p = \left({\|x_1\|^p + \|x_2\|^p + \cdots + \|x_n\|^p} \right)^{1/p}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%20%5Cvec%7Bx%7D%20%7C%7C_p%20%3D%20%5Cleft%28%7B%7Cx_1%7C%5Ep%20%2B%20%7Cx_2%7C%5Ep%20%2B%20%5Ccdots%20%2B%20%7Cx_n%7C%5Ep%7D%20%5Cright%29%5E%7B1%2Fp%7D. "|| \vec{x} ||_p = \left({|x_1|^p + |x_2|^p + \cdots + |x_n|^p} \right)^{1/p}.")
...
![\|\| \vec{x} \|\|\_\infty = \max{\left(\| x_1\|, \| x_2\|,  \ldots, \|x_n\|\right)}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%20%5Cvec%7Bx%7D%20%7C%7C_%5Cinfty%20%3D%20%5Cmax%7B%5Cleft%28%7C%20x_1%7C%2C%20%7C%20x_2%7C%2C%20%20%5Cldots%2C%20%7Cx_n%7C%5Cright%29%7D "|| \vec{x} ||_\infty = \max{\left(| x_1|, | x_2|,  \ldots, |x_n|\right)}")
...
![\|\|\mat{A}\|\|\_p = \max\_{\vec{x} \not = \mathbf{ 0}} \frac{ \|\| \mat{A} \vec{x}\|\|\_p} { \|\|\vec{x}\|\|\_p} = \max\_{\|\|\vec{x}\|\|\_p  = 1}  \|\| \mat{A} \vec{x}\|\|\_p](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%5Cmat%7BA%7D%7C%7C_p%20%3D%20%5Cmax_%7B%5Cvec%7Bx%7D%20%5Cnot%20%3D%20%5Cmathbf%7B%200%7D%7D%20%5Cfrac%7B%20%7C%7C%20%5Cmat%7BA%7D%20%5Cvec%7Bx%7D%7C%7C_p%7D%20%7B%20%7C%7C%5Cvec%7Bx%7D%7C%7C_p%7D%20%3D%20%5Cmax_%7B%7C%7C%5Cvec%7Bx%7D%7C%7C_p%20%20%3D%201%7D%20%20%7C%7C%20%5Cmat%7BA%7D%20%5Cvec%7Bx%7D%7C%7C_p "||\mat{A}||_p = \max_{\vec{x} \not = \mathbf{ 0}} \frac{ || \mat{A} \vec{x}||_p} { ||\vec{x}||_p} = \max_{||\vec{x}||_p  = 1}  || \mat{A} \vec{x}||_p")
...
![\|\|\mat{A}\|\|\_p](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%5Cmat%7BA%7D%7C%7C_p "||\mat{A}||_p")
...
![\|\|\mat{A} \|\|\_1 = \displaystyle{\max\_{1 \le j \le n} \sum\_{i=1}^n \|a\_{ij}\|} = \text{maximum absolute column sum}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%5Cmat%7BA%7D%20%7C%7C_1%20%3D%20%5Cdisplaystyle%7B%5Cmax_%7B1%20%5Cle%20j%20%5Cle%20n%7D%20%5Csum_%7Bi%3D1%7D%5En%20%7Ca_%7Bij%7D%7C%7D%20%3D%20%5Ctext%7Bmaximum%20absolute%20column%20sum%7D "||\mat{A} ||_1 = \displaystyle{\max_{1 \le j \le n} \sum_{i=1}^n |a_{ij}|} = \text{maximum absolute column sum}")

-   ![p=2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;p%3D2 "p=2")

![\|\| \mat{A} \|\|\_2 = \sqrt{\max\\{ \text{eigenvalue}(A^TA) \\} }](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%20%5Cmat%7BA%7D%20%7C%7C_2%20%3D%20%5Csqrt%7B%5Cmax%5C%7B%20%5Ctext%7Beigenvalue%7D%28A%5ETA%29%20%5C%7D%20%7D "|| \mat{A} ||_2 = \sqrt{\max\{ \text{eigenvalue}(A^TA) \} }")

-   ![p=\infty](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;p%3D%5Cinfty "p=\infty")

![\|\| \mat{A} \|\|\_\infty = \displaystyle{\max\_{1 \le i \le n} \sum\_{j=1}^n \|a\_{ij}\|} = \text{maximum absolute row sum}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%20%5Cmat%7BA%7D%20%7C%7C_%5Cinfty%20%3D%20%5Cdisplaystyle%7B%5Cmax_%7B1%20%5Cle%20i%20%5Cle%20n%7D%20%5Csum_%7Bj%3D1%7D%5En%20%7Ca_%7Bij%7D%7C%7D%20%3D%20%5Ctext%7Bmaximum%20absolute%20row%20sum%7D "|| \mat{A} ||_\infty = \displaystyle{\max_{1 \le i \le n} \sum_{j=1}^n |a_{ij}|} = \text{maximum absolute row sum}")
...
![\|\|\mat{A}\vec{x}\|\|\_p \leq \|\|\mat{A}\|\|\_p \|\|\vec{x}\|\|\_p.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D%7C%7C_p%20%5Cleq%20%7C%7C%5Cmat%7BA%7D%7C%7C_p%20%7C%7C%5Cvec%7Bx%7D%7C%7C_p. "||\mat{A}\vec{x}||_p \leq ||\mat{A}||_p ||\vec{x}||_p.")

To see this, we start with the right hand side and note

![\|\|\mat{A}\|\|\_p \|\|\vec{x}\|\|\_p = \left( \max\_{\mathbf{y} \not = \mathbf{ 0}} \frac{ \|\| \mat{A} \mathbf{y}\|\|\_p} { \|\|\mathbf{y}\|\|\_p} \right) \|\|\vec{x}\|\|\_p \geq \frac{ \|\| \mat{A} \vec{x}\|\|\_p} { \|\|\vec{x}\|\|\_p} \|\|\vec{x}\|\|\_p = \|\| \mat{A} \vec{x}\|\|\_p.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%7C%7C%5Cmat%7BA%7D%7C%7C_p%20%7C%7C%5Cvec%7Bx%7D%7C%7C_p%20%3D%20%5Cleft%28%20%5Cmax_%7B%5Cmathbf%7By%7D%20%5Cnot%20%3D%20%5Cmathbf%7B%200%7D%7D%20%5Cfrac%7B%20%7C%7C%20%5Cmat%7BA%7D%20%5Cmathbf%7By%7D%7C%7C_p%7D%20%7B%20%7C%7C%5Cmathbf%7By%7D%7C%7C_p%7D%20%5Cright%29%20%7C%7C%5Cvec%7Bx%7D%7C%7C_p%20%5Cgeq%20%5Cfrac%7B%20%7C%7C%20%5Cmat%7BA%7D%20%5Cvec%7Bx%7D%7C%7C_p%7D%20%7B%20%7C%7C%5Cvec%7Bx%7D%7C%7C_p%7D%20%7C%7C%5Cvec%7Bx%7D%7C%7C_p%20%3D%20%7C%7C%20%5Cmat%7BA%7D%20%5Cvec%7Bx%7D%7C%7C_p. "||\mat{A}||_p ||\vec{x}||_p = \left( \max_{\mathbf{y} \not = \mathbf{ 0}} \frac{ || \mat{A} \mathbf{y}||_p} { ||\mathbf{y}||_p} \right) ||\vec{x}||_p \geq \frac{ || \mat{A} \vec{x}||_p} { ||\vec{x}||_p} ||\vec{x}||_p = || \mat{A} \vec{x}||_p.")

## Condition Number for ![\mat{A}\vec{x} = \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D "\mat{A}\vec{x} = \vec{b}")
...
![\frac{\|\|\vec{x}-\vec{x}\_a\|\|}{\|\|\vec{x}\|\|}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfrac%7B%7C%7C%5Cvec%7Bx%7D-%5Cvec%7Bx%7D_a%7C%7C%7D%7B%7C%7C%5Cvec%7Bx%7D%7C%7C%7D "\frac{||\vec{x}-\vec{x}_a||}{||\vec{x}||}")

and the **relative backward error** is

![\frac{\|\|\mat{A}\vec{x}-\mat{A}\vec{x}\_a\|\|}{\|\|\mat{A}\vec{x}\|\|}=\frac{\|\|\vec{b}-\mat{A}\vec{x}\_a\|\|}{\|\|\vec{b}\|\|}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfrac%7B%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D-%5Cmat%7BA%7D%5Cvec%7Bx%7D_a%7C%7C%7D%7B%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D%7C%7C%7D%3D%5Cfrac%7B%7C%7C%5Cvec%7Bb%7D-%5Cmat%7BA%7D%5Cvec%7Bx%7D_a%7C%7C%7D%7B%7C%7C%5Cvec%7Bb%7D%7C%7C%7D. "\frac{||\mat{A}\vec{x}-\mat{A}\vec{x}_a||}{||\mat{A}\vec{x}||}=\frac{||\vec{b}-\mat{A}\vec{x}_a||}{||\vec{b}||}.")

We define **error magnification** as the ratio

![\frac{\text{relative forward error}}{\text{relative backward error}}=\frac{\frac{\|\|\vec{x}-\vec{x}\_a\|\|}{\|\|\vec{x}\|\|}}{\frac{\|\|\vec{b}-\mat{A}\vec{x}\_a\|\|}{\|\|\vec{b}\|\|}}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfrac%7B%5Ctext%7Brelative%20forward%20error%7D%7D%7B%5Ctext%7Brelative%20backward%20error%7D%7D%3D%5Cfrac%7B%5Cfrac%7B%7C%7C%5Cvec%7Bx%7D-%5Cvec%7Bx%7D_a%7C%7C%7D%7B%7C%7C%5Cvec%7Bx%7D%7C%7C%7D%7D%7B%5Cfrac%7B%7C%7C%5Cvec%7Bb%7D-%5Cmat%7BA%7D%5Cvec%7Bx%7D_a%7C%7C%7D%7B%7C%7C%5Cvec%7Bb%7D%7C%7C%7D%7D. "\frac{\text{relative forward error}}{\text{relative backward error}}=\frac{\frac{||\vec{x}-\vec{x}_a||}{||\vec{x}||}}{\frac{||\vec{b}-\mat{A}\vec{x}_a||}{||\vec{b}||}}.")

The **condition number**
![\kappa(\mat{A})](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Ckappa%28%5Cmat%7BA%7D%29 "\kappa(\mat{A})")
...
-   Let
    ![\mat{A} = \begin{pmatrix}0.913 & 0.659 \\\\ 0.457 & 0.330 \end{pmatrix}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%5Cbegin%7Bpmatrix%7D0.913%20%26%200.659%20%5C%5C%200.457%20%26%200.330%20%5Cend%7Bpmatrix%7D "\mat{A} = \begin{pmatrix}0.913 & 0.659 \\ 0.457 & 0.330 \end{pmatrix}")
-   Then
...
-   Let
    ![\vec{b} = \begin{pmatrix} 0.254 \\\\ 0.127 \end{pmatrix}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bb%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%200.254%20%5C%5C%200.127%20%5Cend%7Bpmatrix%7D "\vec{b} = \begin{pmatrix} 0.254 \\ 0.127 \end{pmatrix}")
-   Then
    ![\vec{x} =(1,-1)](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%3D%281%2C-1%29 "\vec{x} =(1,-1)").
-   Consider two approximate solutions
    ![\vec{x}\_{1,2}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D_%7B1%2C2%7D "\vec{x}_{1,2}")
...
\end{array}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Barray%7D%7Blcl%7D%0A%5Cvec%7Bx%7D_1%20%3D%20%28-0.0827%2C0.5%29%20%26%26%20%5Cvec%7Bx%7D_2%20%3D%20%280.999%2C-1.001%29%20%5C%5C%0A%5Ctriangle%20%5Cvec%7Bx%7D_1%20%3D%20%281.0827%2C%20-1.5%29%20%26%26%20%5Ctriangle%20%5Cvec%7Bx%7D_2%20%3D%20%280.001%2C0.001%29%20%5C%5C%0A%7C%7C%5Ctriangle%20%5Cvec%7Bx%7D_1%20%7C%7C%20%3D%201.85%26%26%20%7C%7C%5Ctriangle%20%5Cvec%7Bx%7D_2%7C%7C%20%3D%20.0014%5C%5C%0A%7C%7C%5Ctriangle%20%5Cvec%7Bx%7D_1%20%7C%7C%2F%7C%7C%5Cvec%7Bx%7D%7C%7C%20%3D%201.308%26%26%20%7C%7C%5Ctriangle%20%5Cvec%7Bx%7D_2%7C%7C%2F%7C%7C%5Cvec%7Bx%7D%7C%7C%20%3D%20.001%5C%5C%0A%5Cvec%7Bb%7D_1%20%3D%20%280.2539949%2C%200.1272061%29%20%26%26%20%20%5Cvec%7Bb%7D_2%20%3D%20%280.252428%2C%200.126213%29%20%5C%5C%0A%5Ctriangle%5Cvec%7Bb%7D_1%20%3D%20%280.0000051%2C-%200.0002061%29%20%26%26%20%20%5Ctriangle%5Cvec%7Bb%7D_2%20%3D%20%280.001572%2C%200.000787%29%20%5C%5C%0A%7C%7C%5Ctriangle%20%5Cvec%7Bb%7D_1%20%7C%7C%20%3D%200.000206%26%26%20%7C%7C%5Ctriangle%20%5Cvec%7Bb%7D_2%7C%7C%20%3D%20.00176%5C%5C%0A%7C%7C%5Ctriangle%20%5Cvec%7Bb%7D_1%20%7C%7C%2F%7C%7C%5Cvec%7Bb%7D%7C%7C%20%3D%200.000726%26%26%20%7C%7C%5Ctriangle%20%5Cvec%7Bb%7D_2%7C%7C%2F%7C%7C%5Cvec%7Bb%7D%7C%7C%20%3D%20.0062%5C%5C%0Amag%20%3D%201.8%20%5Ctimes%2010%5E3%20%26%26%20mag%20%3D%201.6%20%5Ctimes%2010%5E1%0A%5Cend%7Barray%7D "\begin{array}{lcl}
\vec{x}_1 = (-0.0827,0.5) && \vec{x}_2 = (0.999,-1.001) \\
\triangle \vec{x}_1 = (1.0827, -1.5) && \triangle \vec{x}_2 = (0.001,0.001) \\
||\triangle \vec{x}_1 || = 1.85&& ||\triangle \vec{x}_2|| = .0014\\
||\triangle \vec{x}_1 ||/||\vec{x}|| = 1.308&& ||\triangle \vec{x}_2||/||\vec{x}|| = .001\\
...
![\kappa_p(\mat{A})=\|\|\mat{A}\|\|\_p\|\|\mat{A}^{-1}\|\|\_p](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Ckappa_p%28%5Cmat%7BA%7D%29%3D%7C%7C%5Cmat%7BA%7D%7C%7C_p%7C%7C%5Cmat%7BA%7D%5E%7B-1%7D%7C%7C_p "\kappa_p(\mat{A})=||\mat{A}||_p||\mat{A}^{-1}||_p")
...
![n \times n](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;n%20%5Ctimes%20n "n \times n")
system
![\mat{A}\vec{x} = \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D "\mat{A}\vec{x} = \vec{b}")
...
![\mat{A}\vec{x} = \vec{b}\_1, \quad \mat{A}\vec{x} = \vec{b}\_2, \quad \mat{A}\vec{x} = \vec{b}\_3, \quad \ldots, \quad \mat{A}\vec{x} = \vec{b}\_M](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D_1%2C%20%5Cquad%20%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D_2%2C%20%5Cquad%20%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D_3%2C%20%5Cquad%20%5Cldots%2C%20%5Cquad%20%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D_M "\mat{A}\vec{x} = \vec{b}_1, \quad \mat{A}\vec{x} = \vec{b}_2, \quad \mat{A}\vec{x} = \vec{b}_3, \quad \ldots, \quad \mat{A}\vec{x} = \vec{b}_M")
...
![\vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bb%7D "\vec{b}")
...
operations. Solving
![\mathbf{LU}\vec{x} = \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7BLU%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D "\mathbf{LU}\vec{x} = \vec{b}")
requires 2 back substitutions, namely one to solve
![\mathbf{L}\mathbf{y} = \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7BL%7D%5Cmathbf%7By%7D%20%3D%20%5Cvec%7Bb%7D "\mathbf{L}\mathbf{y} = \vec{b}")
for
![\mathbf{y}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7By%7D "\mathbf{y}")
and one to solve
![\mathbf{U}\vec{x}=\mathbf{y}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7BU%7D%5Cvec%7Bx%7D%3D%5Cmathbf%7By%7D "\mathbf{U}\vec{x}=\mathbf{y}")
for
![\vec{x}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D "\vec{x}").
This takes
![2n^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;2n%5E2 "2n^2")
operations. So, to solve
![\mat{A}\vec{x} = \vec{b}\_1, \ldots, \mat{A}\vec{x} = \vec{b}\_M](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D_1%2C%20%5Cldots%2C%20%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%3D%20%5Cvec%7Bb%7D_M "\mat{A}\vec{x} = \vec{b}_1, \ldots, \mat{A}\vec{x} = \vec{b}_M")
takes approximately
...
![\mat{A}\_{1:k,1:k}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D_%7B1%3Ak%2C1%3Ak%7D "\mat{A}_{1:k,1:k}")
...
1 & 1 & -1 \\\\
3 & 11 & 5
\end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%0A%5Cbegin%7Bpmatrix%7D%0A1%20%26%203%20%26%201%5C%5C%0A1%20%26%201%20%26%20-1%20%5C%5C%0A3%20%26%2011%20%26%205%0A%5Cend%7Bpmatrix%7D. "\mat{A} = 
\begin{pmatrix}
1 & 3 & 1\\
1 & 1 & -1 \\
3 & 11 & 5
...
Start by defining
![\mathbf{U} = \mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7BU%7D%20%3D%20%5Cmat%7BA%7D "\mathbf{U} = \mat{A}")
...
![\mat{A}\vec{x}=\vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cvec%7Bx%7D%3D%5Cvec%7Bb%7D "\mat{A}\vec{x}=\vec{b}").
Let
![\mat{A} = \mathbf{D} + \mathbf{R}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%5Cmathbf%7BD%7D%20%2B%20%5Cmathbf%7BR%7D "\mat{A} = \mathbf{D} + \mathbf{R}")
where
...
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%5Cmat%7BA%7D%5Cvec%7Bx%7D%20%26%3D%20%5Cvec%7Bb%7D%20%5C%5C%0A%28%5Cmathbf%7BD%7D%2B%5Cmathbf%7BR%7D%29%5Cvec%7Bx%7D%20%26%3D%20%5Cvec%7Bb%7D%20%5C%5C%0A%5Cmathbf%7BD%7D%5Cvec%7Bx%7D%20%2B%20%5Cmathbf%7BR%7D%20%5Cvec%7Bx%7D%20%26%3D%20%5Cvec%7Bb%7D%5C%5C%0A%5Cmathbf%7BD%7D%20%5Cvec%7Bx%7D%20%26%3D%20%5Cvec%7Bb%7D%20-%20%5Cmathbf%7BR%7D%20%5Cvec%7Bx%7D%5C%5C%0A%5Cvec%7Bx%7D%20%26%3D%20%5Cmathbf%7BD%7D%5E%7B-1%7D%20%28%5Cvec%7Bb%7D-%5Cmathbf%7BR%7D%5Cvec%7Bx%7D%29%0A%5Cend%7Balign%7D "\begin{align}
\mat{A}\vec{x} &= \vec{b} \\
(\mathbf{D}+\mathbf{R})\vec{x} &= \vec{b} \\
\mathbf{D}\vec{x} + \mathbf{R} \vec{x} &= \vec{b}\\
\mathbf{D} \vec{x} &= \vec{b} - \mathbf{R} \vec{x}\\
...
![\vec{x}\_{i+1} = \mathbf{D}^{-1} (\vec{b}-\mathbf{R}\vec{x}\_i).](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D_%7Bi%2B1%7D%20%3D%20%5Cmathbf%7BD%7D%5E%7B-1%7D%20%28%5Cvec%7Bb%7D-%5Cmathbf%7BR%7D%5Cvec%7Bx%7D_i%29. "\vec{x}_{i+1} = \mathbf{D}^{-1} (\vec{b}-\mathbf{R}\vec{x}_i).")
...
![\mat{A} = (2,1)^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%282%2C1%29%5ET "\mat{A} = (2,1)^T")
and tell you to use it to reach the target vector
![\vec{b}=(6,8)^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bb%7D%3D%286%2C8%29%5ET "\vec{b}=(6,8)^T").
Well, you can’t do it exactly because there is no scalar
![x](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x "x")
such that
![x\mat{A} = \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x%5Cmat%7BA%7D%20%3D%20%5Cvec%7Bb%7D "x\mat{A} = \vec{b}").
So let us do the next best thing: let’s find the value of
![x](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x "x")
such that
![x\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x%5Cmat%7BA%7D "x\mat{A}")
...
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0Ax%5Cmat%7BA%7D%20%2B%20%5Cmathbf%7Br%7D%26%3D%5Cvec%7Bb%7D%5C%5C%0A%5Cmat%7BA%7D%20%5Ccdot%20%5Cmathbf%7Br%7D%20%26%3D0.%0A%5Cend%7Balign%7D "\begin{align}
x\mat{A} + \mathbf{r}&=\vec{b}\\
\mat{A} \cdot \mathbf{r} &=0.
\end{align}")
...
![\mat{A} \cdot \mat{A}x + \mat{A} \cdot \mathbf{r} = \mat{A} \cdot \vec{b}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Ccdot%20%5Cmat%7BA%7Dx%20%2B%20%5Cmat%7BA%7D%20%5Ccdot%20%5Cmathbf%7Br%7D%20%3D%20%5Cmat%7BA%7D%20%5Ccdot%20%5Cvec%7Bb%7D. "\mat{A} \cdot \mat{A}x + \mat{A} \cdot \mathbf{r} = \mat{A} \cdot \vec{b}.")

From the second equation above, we can eliminate the second term on the
left hand side to write

![\mat{A}^T \mat{A} x = \mat{A}^T \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%20x%20%3D%20%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D "\mat{A}^T \mat{A} x = \mat{A}^T \vec{b}")
...
![\vec{x}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D "\vec{x}")
by writing
![x = \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x%20%3D%20%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D "x = \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}").
We can also calculate the vector that was as close as possible to
![\vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bb%7D "\vec{b}").
We will call it
![\widehat{\vec{b}}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cwidehat%7B%5Cvec%7Bb%7D%7D "\widehat{\vec{b}}")
and it is
...
& = \mathbf{P} \vec{b}.
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%5Cwidehat%7B%5Cvec%7Bb%7D%7D%20%26%3D%20%5Cmat%7BA%7Dx%20%5C%5C%0A%26%3D%5Cmat%7BA%7D%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D%5C%5C%0A%26%20%3D%20%5Cmathbf%7BP%7D%20%5Cvec%7Bb%7D.%0A%5Cend%7Balign%7D "\begin{align}
\widehat{\vec{b}} &= \mat{A}x \\
&=\mat{A}\left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}\\
& = \mathbf{P} \vec{b}.
\end{align}")
...
![\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D "\mat{A}").
We found
![\widehat{\vec{b}} = \mat{A}x](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cwidehat%7B%5Cvec%7Bb%7D%7D%20%3D%20%5Cmat%7BA%7Dx "\widehat{\vec{b}} = \mat{A}x"),
where
![x](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x "x")
...
![x = \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x%20%3D%20%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D "x = \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}")
where
![\left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET "\left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T")
is called the **pseudoinverse** of
![\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D "\mat{A}").
Also, we can summarize the calculation of
![\widehat{\vec{b}}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cwidehat%7B%5Cvec%7Bb%7D%7D "\widehat{\vec{b}}")
as
![\widehat{\vec{b}} = \mathbf{P} \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cwidehat%7B%5Cvec%7Bb%7D%7D%20%3D%20%5Cmathbf%7BP%7D%20%5Cvec%7Bb%7D "\widehat{\vec{b}} = \mathbf{P} \vec{b}")
where
![\mathbf{P} = \mat{A} (\mat{A}^T\mat{A})^{-1} \mat{A}^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7BP%7D%20%3D%20%5Cmat%7BA%7D%20%28%5Cmat%7BA%7D%5ET%5Cmat%7BA%7D%29%5E%7B-1%7D%20%5Cmat%7BA%7D%5ET "\mathbf{P} = \mat{A} (\mat{A}^T\mat{A})^{-1} \mat{A}^T")
...
![\mathbf{r} = \vec{b}-\widehat{\vec{b}}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7Br%7D%20%3D%20%5Cvec%7Bb%7D-%5Cwidehat%7B%5Cvec%7Bb%7D%7D "\mathbf{r} = \vec{b}-\widehat{\vec{b}}").
...
![x_0 \mat{A}\_0 + x_1 \mat{A}\_1 = \vec{b}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;x_0%20%5Cmat%7BA%7D_0%20%2B%20x_1%20%5Cmat%7BA%7D_1%20%3D%20%5Cvec%7Bb%7D. "x_0 \mat{A}_0 + x_1 \mat{A}_1 = \vec{b}.")

We’d like to reach
![\vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bb%7D "\vec{b}")
using the basis vectors
![\mat{A}\_{0,1}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D_%7B0%2C1%7D "\mat{A}_{0,1}"),
...
a_0 \cdot \mathbf{r} &= 0 \\\\
a_1 \cdot \mathbf{r} &= 0.
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0Ax_0%20%5Cmat%7BA%7D_0%20%2B%20x_1%20%5Cmathbf%7Ba_1%7D%20%2B%20%5Cmathbf%7Br%7D%20%26%3D%20%5Cvec%7Bb%7D%20%5C%5C%0Aa_0%20%5Ccdot%20%5Cmathbf%7Br%7D%20%26%3D%200%20%5C%5C%0Aa_1%20%5Ccdot%20%5Cmathbf%7Br%7D%20%26%3D%200.%0A%5Cend%7Balign%7D "\begin{align}
x_0 \mat{A}_0 + x_1 \mathbf{a_1} + \mathbf{r} &= \vec{b} \\
a_0 \cdot \mathbf{r} &= 0 \\
a_1 \cdot \mathbf{r} &= 0.
\end{align}")
...
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0Ax_0%20%5Cmat%7BA%7D_0%5Ccdot%5Cmat%7BA%7D_0%20%2B%20x_1%20%5Cmat%7BA%7D_0%5Ccdot%5Cmat%7BA%7D_1%20%26%3D%20%5Cmat%7BA%7D_0%20%5Ccdot%20%5Cvec%7Bb%7D%5C%5C%0Ax_0%20%5Cmat%7BA%7D_1%5Ccdot%5Cmat%7BA%7D_0%20%2B%20x_1%20%5Cmat%7BA%7D_1%5Ccdot%5Cmat%7BA%7D_1%20%26%3D%20%5Cmat%7BA%7D_1%20%5Ccdot%20%5Cvec%7Bb%7D%0A%5Cend%7Balign%7D "\begin{align}
x_0 \mat{A}_0\cdot\mat{A}_0 + x_1 \mat{A}_0\cdot\mat{A}_1 &= \mat{A}_0 \cdot \vec{b}\\
x_0 \mat{A}_1\cdot\mat{A}_0 + x_1 \mat{A}_1\cdot\mat{A}_1 &= \mat{A}_1 \cdot \vec{b}
\end{align}")
...
![\begin{pmatrix} \mat{A}\_0^T \\\\ \mat{A}\_1^T \end{pmatrix} \begin{pmatrix} \mat{A}\_0 & \mat{A}\_1 \end{pmatrix} \begin{pmatrix} x_0 \\\\ x_1 \end{pmatrix} = \begin{pmatrix} \mat{A}\_0^T \\\\ \mat{A}\_1^T \end{pmatrix} \vec{b}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Bpmatrix%7D%20%5Cmat%7BA%7D_0%5ET%20%5C%5C%20%5Cmat%7BA%7D_1%5ET%20%5Cend%7Bpmatrix%7D%20%5Cbegin%7Bpmatrix%7D%20%5Cmat%7BA%7D_0%20%26%20%5Cmat%7BA%7D_1%20%5Cend%7Bpmatrix%7D%20%5Cbegin%7Bpmatrix%7D%20x_0%20%5C%5C%20x_1%20%5Cend%7Bpmatrix%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%20%5Cmat%7BA%7D_0%5ET%20%5C%5C%20%5Cmat%7BA%7D_1%5ET%20%5Cend%7Bpmatrix%7D%20%5Cvec%7Bb%7D. "\begin{pmatrix} \mat{A}_0^T \\ \mat{A}_1^T \end{pmatrix} \begin{pmatrix} \mat{A}_0 & \mat{A}_1 \end{pmatrix} \begin{pmatrix} x_0 \\ x_1 \end{pmatrix} = \begin{pmatrix} \mat{A}_0^T \\ \mat{A}_1^T \end{pmatrix} \vec{b}.")
...
![\mat{A}\_{0,1}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D_%7B0%2C1%7D "\mat{A}_{0,1}")
and if we let
![\vec{x}=(x_0,x_1)^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%3D%28x_0%2Cx_1%29%5ET "\vec{x}=(x_0,x_1)^T")
then we can write the last equation as

![\mat{A}^T \mat{A} \vec{x} = \mat{A}^T \vec{b}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%20%5Cvec%7Bx%7D%20%3D%20%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D. "\mat{A}^T \mat{A} \vec{x} = \mat{A}^T \vec{b}.")
...
![\vec{x} = \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D%20%3D%20%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D "\vec{x} = \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}")
where
![\left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET "\left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T")
is the pseudoinverse. The projection is
![\widehat{\vec{b}} = \mat{A} \vec{x} = \mat{A} \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cwidehat%7B%5Cvec%7Bb%7D%7D%20%3D%20%5Cmat%7BA%7D%20%5Cvec%7Bx%7D%20%3D%20%5Cmat%7BA%7D%20%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D "\widehat{\vec{b}} = \mat{A} \vec{x} = \mat{A} \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T \vec{b}")
where
![\mat{A} \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Cleft%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%5Cright%29%5E%7B-1%7D%5Cmat%7BA%7D%5ET "\mat{A} \left(\mat{A}^T \mat{A}\right)^{-1}\mat{A}^T")
...
4.  Solve the normal equations
    ![\mat{A}^T\mat{A}\vec{x}=\mat{A}^T \vec{b}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5ET%5Cmat%7BA%7D%5Cvec%7Bx%7D%3D%5Cmat%7BA%7D%5ET%20%5Cvec%7Bb%7D "\mat{A}^T\mat{A}\vec{x}=\mat{A}^T \vec{b}").
...
![\frac{1}{2}\|\|\mathbf{r}\|\|^2 = \frac{1}{2}\|\|\mat{A}\vec{x}-\vec{b}\|\|^2.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cfrac%7B1%7D%7B2%7D%7C%7C%5Cmathbf%7Br%7D%7C%7C%5E2%20%3D%20%5Cfrac%7B1%7D%7B2%7D%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D-%5Cvec%7Bb%7D%7C%7C%5E2. "\frac{1}{2}||\mathbf{r}||^2 = \frac{1}{2}||\mat{A}\vec{x}-\vec{b}||^2.")

More formally, we can define the scalar **objective function**

![f(\vec{x}) = \frac{1}{2} \|\|\mat{A}\vec{x}-\vec{b}\|\|^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;f%28%5Cvec%7Bx%7D%29%20%3D%20%5Cfrac%7B1%7D%7B2%7D%20%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D-%5Cvec%7Bb%7D%7C%7C%5E2 "f(\vec{x}) = \frac{1}{2} ||\mat{A}\vec{x}-\vec{b}||^2")

and define our least squares solution
![\vec{x}\_{LS}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D_%7BLS%7D "\vec{x}_{LS}")as
the value of
![\vec{x}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D "\vec{x}")
that minimizes this objective function, that is,

![\vec{x}\_{LS} = \mathop{\mathrm{arg\\,min}}\_{\vec{x}} f(\vec{x}).](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D_%7BLS%7D%20%3D%20%5Cmathop%7B%5Cmathrm%7Barg%5C%2Cmin%7D%7D_%7B%5Cvec%7Bx%7D%7D%20f%28%5Cvec%7Bx%7D%29. "\vec{x}_{LS} = \mathop{\mathrm{arg\,min}}_{\vec{x}} f(\vec{x}).")
...
![\vec{x}\_{LS} = \mathop{\mathrm{arg\\,min}}\_x \frac{1}{2}\|\|\mat{A}\vec{x}-\vec{b}\|\|^2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cvec%7Bx%7D_%7BLS%7D%20%3D%20%5Cmathop%7B%5Cmathrm%7Barg%5C%2Cmin%7D%7D_x%20%5Cfrac%7B1%7D%7B2%7D%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D-%5Cvec%7Bb%7D%7C%7C%5E2 "\vec{x}_{LS} = \mathop{\mathrm{arg\,min}}_x \frac{1}{2}||\mat{A}\vec{x}-\vec{b}||^2")
...
![\mat{A}^T \mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D "\mat{A}^T \mat{A}"):
...
&= \mathbf{I}\_n.
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%20%26%3D%20%5Cbegin%7Bpmatrix%7D%20%5Cmathbf%7Bv%7D_1%5ET%5C%5C%20%5Cmathbf%7Bv%7D_2%5ET%20%5C%5C%20%5Cvdots%20%5C%5C%20%5Cmathbf%7Bv%7D_n%5ET%20%5Cend%7Bpmatrix%7D%20%5Cbegin%7Bpmatrix%7D%20%5Cmathbf%7Bv%7D_1%20%26%20%5Cmathbf%7Bv%7D_2%20%26%20%5Ccdots%20%26%20%5Cmathbf%7Bv%7D_n%20%5Cend%7Bpmatrix%7D%20%5C%5C%0A%26%3D%20%5Cbegin%7Bpmatrix%7D%20%5Cmathbf%7Bv%7D_1%5ET%20%5Cmathbf%7Bv%7D_1%20%26%20%5Cmathbf%7Bv%7D_1%5ET%20%5Cmathbf%7Bv%7D_2%20%26%20%5Ccdots%20%26%20%5Cmathbf%7Bv%7D_1%5ET%20%5Cmathbf%7Bv%7D_n%20%5C%5C%20%5Cmathbf%7Bv%7D_2%5ET%20%5Cmathbf%7Bv%7D_1%20%26%20%5Cmathbf%7Bv%7D_2%5ET%20%5Cmathbf%7Bv%7D_2%20%26%20%5Ccdots%20%26%20%20%5Cmathbf%7Bv%7D_2%5ET%20%5Cmathbf%7Bv%7D_n%20%5C%5C%0A%5Cvdots%20%26%20%5Cvdots%20%26%20%5Ccdots%20%26%20%5Cvdots%20%5C%5C%0A%5Cmathbf%7Bv%7D_n%5ET%20%5Cmathbf%7Bv%7D_1%20%26%20%5Cmathbf%7Bv%7D_n%5ET%20%5Cmathbf%7Bv%7D_2%20%26%20%5Ccdots%20%26%20%5Cmathbf%7Bv%7D_n%5ET%20%5Cmathbf%7Bv%7D_n%0A%5Cend%7Bpmatrix%7D%5C%5C%0A%26%3D%20%5Cbegin%7Bpmatrix%7D%201%20%26%200%20%26%20%5Ccdots%20%26%200%20%5C%5C%200%20%26%201%20%26%20%5Ccdots%20%26%200%5C%5C%20%5Cvdots%20%26%20%5Cvdots%20%26%20%5Ccdots%20%26%20%5Cvdots%20%5C%5C%200%20%26%200%20%26%20%5Ccdots%20%26%201%5Cend%7Bpmatrix%7D%5C%5C%0A%26%3D%20%5Cmathbf%7BI%7D_n.%0A%5Cend%7Balign%7D "\begin{align}
\mat{A}^T \mat{A} &= \begin{pmatrix} \mathbf{v}_1^T\\ \mathbf{v}_2^T \\ \vdots \\ \mathbf{v}_n^T \end{pmatrix} \begin{pmatrix} \mathbf{v}_1 & \mathbf{v}_2 & \cdots & \mathbf{v}_n \end{pmatrix} \\
&= \begin{pmatrix} \mathbf{v}_1^T \mathbf{v}_1 & \mathbf{v}_1^T \mathbf{v}_2 & \cdots & \mathbf{v}_1^T \mathbf{v}_n \\ \mathbf{v}_2^T \mathbf{v}_1 & \mathbf{v}_2^T \mathbf{v}_2 & \cdots &  \mathbf{v}_2^T \mathbf{v}_n \\
\vdots & \vdots & \cdots & \vdots \\
\mathbf{v}_n^T \mathbf{v}_1 & \mathbf{v}_n^T \mathbf{v}_2 & \cdots & \mathbf{v}_n^T \mathbf{v}_n
...
![\mat{A}^T\mat{A} = \mathbf{I}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5ET%5Cmat%7BA%7D%20%3D%20%5Cmathbf%7BI%7D "\mat{A}^T\mat{A} = \mathbf{I}"),
then by definition of inverse,
![\mat{A}^T = \mat{A}^{-1}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5ET%20%3D%20%5Cmat%7BA%7D%5E%7B-1%7D "\mat{A}^T = \mat{A}^{-1}").
...
![\mat{A} = \begin{pmatrix} \| & \| &  & \| \\\\ \mathbf{q}\_1 & \mathbf{q}\_2 & \cdots & \\  \mathbf{q}\_n \\\\\| & \| &  & \| \\\\ \end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%20%7C%20%26%20%7C%20%26%20%20%26%20%7C%20%5C%5C%20%5Cmathbf%7Bq%7D_1%20%26%20%5Cmathbf%7Bq%7D_2%20%26%20%5Ccdots%20%26%20%5C%20%20%5Cmathbf%7Bq%7D_n%20%5C%5C%7C%20%26%20%7C%20%26%20%20%26%20%7C%20%5C%5C%20%5Cend%7Bpmatrix%7D. "\mat{A} = \begin{pmatrix} | & | &  & | \\ \mathbf{q}_1 & \mathbf{q}_2 & \cdots & \  \mathbf{q}_n \\| & | &  & | \\ \end{pmatrix}.")
...
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%5Cmathbf%7BP%7D%5Cmathbf%7Bw%7D%20%26%3D%20%5Cmat%7BA%7D%20%28%5Cmat%7BA%7D%5ET%20%5Cmat%7BA%7D%29%5E%7B-1%7D%20%5Cmat%7BA%7D%5ET%20%5Cmathbf%7Bw%7D%5C%5C%0A%26%3D%20%5Cmat%7BA%7D%20%5Cmat%7BA%7D%5E%7B-1%7D%20%5Cmat%7BA%7D%20%5Cmat%7BA%7D%5ET%20%5Cmathbf%7Bw%7D%20%5C%5C%0A%26%3D%20%5Cmat%7BA%7D%20%5Cmat%7BA%7D%5ET%20%5Cmathbf%7Bw%7D%20%5C%5C%0A%26%3D%20%5Cmathbf%7Bq%7D_1%20%5Cmathbf%7Bq%7D_1%5ET%20%5Cmathbf%7Bw%7D%20%2B%20%5Cmathbf%7Bq%7D_2%20%5Cmathbf%7Bq%7D_2%5ET%20%5Cmathbf%7Bw%7D%20%2B%20%5Ccdots%20%2B%20%5Cmathbf%7Bq%7D_n%20%5Cmathbf%7Bq%7D_n%5ET%20%5Cmathbf%7Bw%7D.%0A%5Cend%7Balign%7D "\begin{align}
\mathbf{P}\mathbf{w} &= \mat{A} (\mat{A}^T \mat{A})^{-1} \mat{A}^T \mathbf{w}\\
&= \mat{A} \mat{A}^{-1} \mat{A} \mat{A}^T \mathbf{w} \\
&= \mat{A} \mat{A}^T \mathbf{w} \\
&= \mathbf{q}_1 \mathbf{q}_1^T \mathbf{w} + \mathbf{q}_2 \mathbf{q}_2^T \mathbf{w} + \cdots + \mathbf{q}_n \mathbf{q}_n^T \mathbf{w}.
...
![\mat{A} = \begin{pmatrix} \frac{1}{3} & \frac{2}{15} \\\\ \frac{2}{3} & \frac{2}{3} \\\\ \frac{2}{3} & -\frac{11}{15} \end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%20%5Cfrac%7B1%7D%7B3%7D%20%26%20%5Cfrac%7B2%7D%7B15%7D%20%5C%5C%20%5Cfrac%7B2%7D%7B3%7D%20%26%20%5Cfrac%7B2%7D%7B3%7D%20%5C%5C%20%5Cfrac%7B2%7D%7B3%7D%20%26%20-%5Cfrac%7B11%7D%7B15%7D%20%5Cend%7Bpmatrix%7D. "\mat{A} = \begin{pmatrix} \frac{1}{3} & \frac{2}{15} \\ \frac{2}{3} & \frac{2}{3} \\ \frac{2}{3} & -\frac{11}{15} \end{pmatrix}.")
...
![\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D "\mat{A}")
as a product
![\mat{A} = \mathbf{Q} \mathbf{R}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%5Cmathbf%7BQ%7D%20%5Cmathbf%7BR%7D "\mat{A} = \mathbf{Q} \mathbf{R}")
where:
...
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%7C%7C%5Cmat%7BA%7D%5Cvec%7Bx%7D-%5Cvec%7Bb%7D%7C%7C%5E2%20%26%3D%20%7C%7C%5Cbar%7B%5Cmathbf%7BQ%7D%7D%5Cbar%7B%5Cmathbf%7BR%7D%7D%20%5Cvec%7Bx%7D%20-%20%5Cvec%7Bb%7D%7C%7C%5E2%20%5C%5C%0A%26%3D%20%7C%7C%5Cbar%7B%5Cmathbf%7BQ%7D%7D%5ET%28%5Cbar%7B%5Cmathbf%7BQ%7D%7D%5Cbar%7B%5Cmathbf%7BR%7D%7D%20%5Cvec%7Bx%7D%20-%20%5Cvec%7Bb%7D%29%7C%7C%5E2%20%5C%5C%0A%26%3D%20%7C%7C%5Cbar%7B%5Cmathbf%7BQ%7D%7D%5ET%20%5Cbar%7B%5Cmathbf%7BQ%7D%7D%5Cbar%7B%5Cmathbf%7BR%7D%7D%20%5Cvec%7Bx%7D%20-%20%5Cbar%7B%5Cmathbf%7BQ%7D%7D%5ET%20%5Cvec%7Bb%7D%7C%7C%5E2%20%5C%5C%0A%26%3D%20%7C%7C%5Cbar%7B%5Cmathbf%7BR%7D%7D%20%5Cvec%7Bx%7D%20-%20%5Cbar%7B%5Cmathbf%7BQ%7D%7D%5ET%20%5Cvec%7Bb%7D%7C%7C%5E2%20%5C%5C%0A%26%20%3D%20%7C%7C%5Cmathbf%7BR%7D%20%5Cvec%7Bx%7D-%5Cmathbf%7BQ%7D%5ET%20%5Cvec%7Bb%7D%7C%7C%5E2%2B%20%7C%7C%5Cwidehat%7B%5Cmathbf%7BQ%7D%7D%5ET%20%5Cvec%7Bb%7D%7C%7C%5E2.%20%0A%5Cend%7Balign%7D "\begin{align}
||\mat{A}\vec{x}-\vec{b}||^2 &= ||\bar{\mathbf{Q}}\bar{\mathbf{R}} \vec{x} - \vec{b}||^2 \\
&= ||\bar{\mathbf{Q}}^T(\bar{\mathbf{Q}}\bar{\mathbf{R}} \vec{x} - \vec{b})||^2 \\
&= ||\bar{\mathbf{Q}}^T \bar{\mathbf{Q}}\bar{\mathbf{R}} \vec{x} - \bar{\mathbf{Q}}^T \vec{b}||^2 \\
&= ||\bar{\mathbf{R}} \vec{x} - \bar{\mathbf{Q}}^T \vec{b}||^2 \\
...
![\mat{A}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D "\mat{A}")
if
![\mat{A}\mathbf{v}=\lambda \mathbf{v}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cmathbf%7Bv%7D%3D%5Clambda%20%5Cmathbf%7Bv%7D "\mat{A}\mathbf{v}=\lambda \mathbf{v}").
...
![\mat{A} \mathbf{v} = \lambda \mathbf{v}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Cmathbf%7Bv%7D%20%3D%20%5Clambda%20%5Cmathbf%7Bv%7D "\mat{A} \mathbf{v} = \lambda \mathbf{v}")
and rearrange it to write
![(\mat{A} - \mathbf{I} \lambda) \mathbf{v} = \mathbf{0}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%28%5Cmat%7BA%7D%20-%20%5Cmathbf%7BI%7D%20%5Clambda%29%20%5Cmathbf%7Bv%7D%20%3D%20%5Cmathbf%7B0%7D "(\mat{A} - \mathbf{I} \lambda) \mathbf{v} = \mathbf{0}").
...
![\det (\mat{A}- \mathbf{I} \lambda) = 0](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cdet%20%28%5Cmat%7BA%7D-%20%5Cmathbf%7BI%7D%20%5Clambda%29%20%3D%200 "\det (\mat{A}- \mathbf{I} \lambda) = 0").
...
![\mat{A}\mathbf{v} = \lambda \mathbf{v} \rightarrow (\mat{A}-\mathbf{I}\lambda)\mathbf{v}=\mathbf{0}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cmathbf%7Bv%7D%20%3D%20%5Clambda%20%5Cmathbf%7Bv%7D%20%5Crightarrow%20%28%5Cmat%7BA%7D-%5Cmathbf%7BI%7D%5Clambda%29%5Cmathbf%7Bv%7D%3D%5Cmathbf%7B0%7D "\mat{A}\mathbf{v} = \lambda \mathbf{v} \rightarrow (\mat{A}-\mathbf{I}\lambda)\mathbf{v}=\mathbf{0}")
and solve for
![\mathbf{v}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7Bv%7D "\mathbf{v}").
...
1.  Solve the characteristic equation
    ...
    ![\lambda_i](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Clambda_i "\lambda_i").
2.  Solve
    ![(\mat{A}-\mathbf{I}\lambda_i)\mathbf{v_i}=\mathbf{0}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%28%5Cmat%7BA%7D-%5Cmathbf%7BI%7D%5Clambda_i%29%5Cmathbf%7Bv_i%7D%3D%5Cmathbf%7B0%7D "(\mat{A}-\mathbf{I}\lambda_i)\mathbf{v_i}=\mathbf{0}")
    to find the
    ![\mathbf{v}\_i](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmathbf%7Bv%7D_i "\mathbf{v}_i").

For example, let’s find the eigenvalues and eigenvectors of

![\mat{A} = \begin{pmatrix} -3 & 2 \\\\ 2 & -3 \end{pmatrix}.](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%5Cbegin%7Bpmatrix%7D%20-3%20%26%202%20%5C%5C%202%20%26%20-3%20%5Cend%7Bpmatrix%7D. "\mat{A} = \begin{pmatrix} -3 & 2 \\ 2 & -3 \end{pmatrix}.")
...
(\lambda+5)(\lambda+1) &= 0
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%5Cdet%20%28%5Cmat%7BA%7D%20-%20%5Cmathbf%7BI%7D%20%5Clambda%29%20%26%3D%200%5C%5C%0A%5Cdet%20%5Cbegin%7Bpmatrix%7D%20-3%20-%20%5Clambda%20%26%202%20%5C%5C%202%20%26%20-3%20-%20%5Clambda%20%5Cend%7Bpmatrix%7D%20%26%3D%200%5C%5C%0A%28%5Clambda%2B3%29%5E2-4%20%26%3D%200%5C%5C%0A%5Clambda%5E2%20%2B%206%5Clambda%20%2B%205%20%26%3D%200%5C%5C%0A%28%5Clambda%2B5%29%28%5Clambda%2B1%29%20%26%3D%200%0A%5Cend%7Balign%7D "\begin{align}
\det (\mat{A} - \mathbf{I} \lambda) &= 0\\
\det \begin{pmatrix} -3 - \lambda & 2 \\ 2 & -3 - \lambda \end{pmatrix} &= 0\\
(\lambda+3)^2-4 &= 0\\
\lambda^2 + 6\lambda + 5 &= 0\\
...
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%28%5Cmat%7BA%7D-%5Cmathbf%7BI%7D%5Clambda_1%29%5Cmathbf%7Bv%7D_1%26%3D%5Cmathbf%7B0%7D%5C%5C%0A%5Cbegin%7Bpmatrix%7D%20-2%20%26%202%20%5C%5C%202%20%26%20-2%20%5Cend%7Bpmatrix%7D%5Cmathbf%7Bv%7D_1%20%26%3D%20%5Cmathbf%7B0%7D%20%5C%5C%0A%5Cmathbf%7Bv%7D_1%20%26%3D%20%5Cbegin%7Bpmatrix%7D%201%20%5C%5C%201%20%5Cend%7Bpmatrix%7D%0A%5Cend%7Balign%7D "\begin{align}
(\mat{A}-\mathbf{I}\lambda_1)\mathbf{v}_1&=\mathbf{0}\\
\begin{pmatrix} -2 & 2 \\ 2 & -2 \end{pmatrix}\mathbf{v}_1 &= \mathbf{0} \\
\mathbf{v}_1 &= \begin{pmatrix} 1 \\ 1 \end{pmatrix}
\end{align}")
...
simultaneously:
![\mat{A} \mathbf{v}\_i = \lambda_i \mathbf{v}\_i](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%5Cmathbf%7Bv%7D_i%20%3D%20%5Clambda_i%20%5Cmathbf%7Bv%7D_i "\mat{A} \mathbf{v}_i = \lambda_i \mathbf{v}_i")
implies
...
\end{align}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbegin%7Balign%7D%0A%5Cmat%7BA%7D%20%5Cunderbrace%7B%5Cbegin%7Bpmatrix%7D%0A%5Cvert%20%26%20%5Cvert%20%26%20%5Ccdots%20%26%20%5Cvert%20%5C%5C%0A%5Cmathbf%7Bv%7D_1%20%26%20%5Cmathbf%7Bv%7D_2%20%26%20%5Ccdots%20%26%20%5Cmathbf%7Bv%7D_n%20%5C%5C%0A%5Cvert%20%26%20%5Cvert%20%26%20%5Ccdots%20%26%20%5Cvert%20%0A%5Cend%7Bpmatrix%7D%7D_%5Cmathbf%7BS%7D%20%26%3D%20%0A%7B%5Cbegin%7Bpmatrix%7D%20%5Cvert%20%26%20%5Cvert%20%26%20%5Ccdots%20%26%20%5Cvert%20%5C%5C%0A%5Clambda_1%20%5Cmathbf%7Bv%7D_1%20%26%20%5Clambda_2%20%5Cmathbf%7Bv%7D_2%20%26%20%5Ccdots%20%26%20%5Clambda_n%20%5Cmathbf%7Bv%7D_n%20%5C%5C%0A%5Cvert%20%26%20%5Cvert%20%26%20%5Ccdots%20%26%20%5Cvert%20%0A%5Cend%7Bpmatrix%7D%7D%20%5C%5C%0A%26%3D%5Cunderbrace%7B%5Cbegin%7Bpmatrix%7D%20%5Cvert%20%26%20%5Cvert%20%26%20%5Ccdots%20%26%20%5Cvert%20%5C%5C%0A%5Cmathbf%7Bv%7D_1%20%26%20%5Cmathbf%7Bv%7D_2%20%26%20%5Ccdots%20%26%20%5Cmathbf%7Bv%7D_n%20%5C%5C%0A%5Cvert%20%26%20%5Cvert%20%26%20%5Ccdots%20%26%20%5Cvert%20%0A%5Cend%7Bpmatrix%7D%7D_%5Cmathbf%7BS%7D%0A%5Cunderbrace%7B%5Cbegin%7Bpmatrix%7D%20%5Clambda_1%20%26%26%26%20%5C%5C%20%26%20%5Clambda_2%20%26%20%26%20%5C%5C%20%26%26%20%5Cddots%20%26%20%5C%5C%20%26%26%26%20%5Clambda_n%20%20%20%5Cend%7Bpmatrix%7D%7D_%5Cmathbf%7B%5CLambda%7D.%0A%5Cend%7Balign%7D "\begin{align}
\mat{A} \underbrace{\begin{pmatrix}
\vert & \vert & \cdots & \vert \\
\mathbf{v}_1 & \mathbf{v}_2 & \cdots & \mathbf{v}_n \\
\vert & \vert & \cdots & \vert 
...
Since
![\mat{A}\mathbf{S} = \mathbf{S} \mathbf{\Lambda}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%5Cmathbf%7BS%7D%20%3D%20%5Cmathbf%7BS%7D%20%5Cmathbf%7B%5CLambda%7D "\mat{A}\mathbf{S} = \mathbf{S} \mathbf{\Lambda}"),
we can write
![\mat{A} = \mathbf{S} \mathbf{\Lambda} \mathbf{S}^{-1}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cmat%7BA%7D%20%3D%20%5Cmathbf%7BS%7D%20%5Cmathbf%7B%5CLambda%7D%20%5Cmathbf%7BS%7D%5E%7B-1%7D "\mat{A} = \mathbf{S} \mathbf{\Lambda} \mathbf{S}^{-1}").
If we think of
