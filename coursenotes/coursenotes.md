...
$$
x\_1 \begin{pmatrix} 2 \\\\ 1 \\\\ -2 \end{pmatrix} + x\_2 \begin{pmatrix} 4 \\\\ 4 \\\\ -6 \end{pmatrix} + x\_3 \begin{pmatrix} -2 \\\\ -3 \\\\ 7 \end{pmatrix} = \begin{pmatrix} 8 \\\\ 8 \\\\ -3 \end{pmatrix}
$$
...
{:start=“3”} 3. The **eigenvalues** *λ*<sub>*i*</sub> of **A** satisfy
...
{:start=“4”} 4. **A****z** ≠ 0 for all **z** ∈ ℝ<sup>*n*</sup> except
...
1.  **Nullspace** just means the parts of ℝ<sup>*n*</sup> that gets
...
2.  If vectors are **linearly independent**, it means that none of the
...
{:start=“7”} 7. **Span** means the set of points reachable by taking
linear combinations of a set of vectors. If you have *n* linearly
independent vectors in ℝ<sup>*n*</sup>, they span ℝ<sup>*n*</sup>. The
**rank** of 𝔸 is just the dimension of the space spanned by the column
vectors.

1.  The **image** of **A** means all the points that **A** can map to.
...
2.  **A****x** = **b** has a unique solution for all **b**⇔ **A** is
