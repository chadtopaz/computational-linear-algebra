...
Let's use Gaussian elimination with the `echelon` command and **LU** decomposition with the ``lu` command and back substitution to compare the time for solving a $10 \times 10$ system for $100$ different right hand sides.
