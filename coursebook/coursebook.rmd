...
Step 3.  Think of $fred$ as made up of stuff in the subspace spanned by ${\vec{q}_{1,2}}$ and stuff orthogonal to it. Throw away stuff in the span of ${\vec{q}_{1,2}}$ since we have it covered already. Take what's left of $\vec{v}_3$ and turn it unto a unit vector.
