...
\$ *{1,2} \$ and stuff orthogonal to it. Throw away stuff in the span of
$\mathbf{q}_{1,2}$ since we have it covered already. Take what’s left of
$\mathbf{v}_3$ and turn it unto a unit vector.
